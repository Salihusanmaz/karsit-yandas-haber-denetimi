...
print("\nBERT Misleading Classification Report:")
print(
    classification_report(
        y_true,
        y_pred,
        labels=[0, 1, 2, 3],
        target_names=["yok", "dusuk", "orta", "yuksek"],
        zero_division=0
    )
)
...
model.save_pretrained("./bert_misleading_model")
tokenizer.save_pretrained("./bert_misleading_model")

print("\nModel kaydedildi: bert_misleading_model")